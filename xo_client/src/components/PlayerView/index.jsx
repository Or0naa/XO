...
export default function PlayerView({ jender, name, turn, sigh, winnings }) {
    ...
    const [playerImg, setPlayerImg] = useState(jender === "man" ? './male.png' : './female.png');
    ...
    return (
        ...
        <div className={turn ? style.turnPlyer : style.otherPlayer}>
            <img src={playerImg} alt="playerImg" style={{ borderColor: 'black', borderWidth: "3px", borderRadius: "50%", border: "solid" }} />
